...
const AreaList = () => {
    ...
    const { deleteAreas } = useContext(AreaContext)
    ...
    const handledetalle = (nocia, rowId) => {
        ...
        return usenavigate(`/detailsArea/${nocia}/${rowId}`)

    };
    const handleditar = (rowId) => {

        return usenavigate(`/editarArea/${rowId}`)
    ...
    return (<div>
            ...
            <div className="d-flex mb-3 justify-content-between">
                ...
                <div className="flex flex-wrap gap-2 justify-content-between align-items-center">
                    ...
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Buscar Area" />
                    </span>
                </div>
        ...
        <div className="card">
            ...
            <ToggleButton checked={true} onChange={(e) => setBalanceFrozen(e.value)} onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Lista de Areas" offLabel="Lista de Areas" />
            <DataTable value={areas} paginator rows={10} scrollable /*scrollHeight="400" */ className="mt-4"
                ...
                <Column field="NOMBRE" header="AREA" style={{ minWidth: '100px' }} sortable></Column>
