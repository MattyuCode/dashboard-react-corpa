...
const ActividadList = () => {
    ...
    const { deleteActividad } = useContext(ActividadContext)
    ...
    const handledetalle = (rowNocia, rowId) => {
        ...
        return usenavigate(`/detailsActividad/${rowNocia}/${rowId}`)

    };
    const handleditar = (rowId) => {

        return usenavigate(`/editarActividad/${rowId}`)

    };

    const handleliminar = (rowId) => {
        deleteActividad(rowId)
    ...
    return (<div>
            ...
            <div className="d-flex mb-3 justify-content-between">
                ...
                <div className="flex flex-wrap gap-2 justify-content-between align-items-center">
                    ...
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Buscar Actividad" />
                    </span>
                </div>
        ...
        <div className="card">
            ...
            <ToggleButton checked={true} onChange={(e) => setBalanceFrozen(e.value)} onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Lista de Actividades"  />
            <DataTable value={actividades} paginator rows={10} scrollable /*scrollHeight="400" */ className="mt-4"
                ...
                <Column field="NOMBRE" header="ACTIVIDAD" style={{ minWidth: '100px' }} sortable></Column>
