  ...
  const fetchAPIEditar = async (name, idpro, descr) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Advertencia actualizado exitosamente",
      }).then(() => {
    ...
    <div className="container  mt-4">
      <div className="row" style={{ padding: "0 5rem" }}>
        <div className="col-md-12">
          <span className="titless text-center">Editar Advertencia</span>
        </div>
...
export default EditAdvertencia;
