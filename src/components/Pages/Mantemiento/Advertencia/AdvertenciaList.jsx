...
import { AdvertenciaContext } from "../../../../contexts/AdvertenciaContext";
...
const AdvertenciaList = () => {


    const usenavigate = useNavigate();

    const { advertencias } = useContext(AdvertenciaContext)

    const { deleteAdvertencias } = useContext(AdvertenciaContext)
    ...
    const handledetalle = (rowNocia, rowId) => {
        ...
        return usenavigate(`/detallesAdvertencia/${rowNocia}/${rowId}`)

    };
    const handleditar = (rowId) => {

        return usenavigate(`/editarAdvertencia/${rowId}`)

    };

    const handleliminar = (rowId) => {
        deleteAdvertencias(rowId)
    ...
    return (<div>
            ...
            <div className="d-flex mb-3 justify-content-between">
                ...
                <div className="flex flex-wrap gap-2 justify-content-between align-items-center">
                    ...
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Buscar Advertencia" />
                    </span>
                </div>
        ...
        <div className="card">
            ...
            <ToggleButton checked={true} onChange={(e) => setBalanceFrozen(e.value)} onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Lista de Advertencias" />
            <DataTable value={advertencias} paginator rows={10} scrollable /*scrollHeight="400" */ className="mt-4"
...
export default AdvertenciaList;