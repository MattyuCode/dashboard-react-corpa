...
const EtapaList = () => {
    ...
    const { etapas } = useContext(EtapaContext)

    const { deleteEtapas } = useContext(EtapaContext)
    ...
    const handledetalle = (nocia, rowId) => {

        return usenavigate(`/detallesEtapa/${nocia}/${rowId}`)

    };
    const handleditar = (rowId) => {

        return usenavigate(`/editarEtapa/${rowId}`)
    ...
    return (<div>
            ...
            <div className="d-flex mb-3 justify-content-between">
                ...
                <div className="flex flex-wrap gap-2 justify-content-between align-items-center">
                    ...
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Buscar Etapa" />
                    </span>
                </div>
        ...
        <div className="card">
            ...
            <ToggleButton checked={true} onChange={(e) => setBalanceFrozen(e.value)} onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Lista de Etapas" offLabel="Lista de Etapas" />
            <DataTable value={etapas} paginator rows={10} scrollable /*scrollHeight="400" */ className="mt-4"
                ...
                <Column field="NOMBRE" header="ETAPA" style={{ minWidth: '100px' }} sortable></Column>
