...
import { SubAreaContext } from "../../../../contexts/SubAreaContext";
...
const SubAreaList = () => {
    ...
    const { subareas } = useContext(SubAreaContext)

    const { deleteEquipos } = useContext(SubAreaContext)
    ...
    const handledetalle = ( rowId) => {
        ...
        return usenavigate(`/DetailsSubArea/${rowId}`)

    };
    const handleditar = (rowId) => {

        return usenavigate(`/crearSubArea/${rowId}`)
    ...
    return (<div>
            ...
            <div className="d-flex mb-3 justify-content-between">
                ...
                <div className="flex flex-wrap gap-2 justify-content-between align-items-center">
                    ...
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Buscar SubArea" />
                    </span>
                </div>
        ...
        <div className="card">
            ...
            <ToggleButton checked={true} onChange={(e) => setBalanceFrozen(e.value)} onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Lista de SubAreas" offLabel="Lista de Etapas" />
            <DataTable value={subareas} paginator rows={10} scrollable /*scrollHeight="400" */ className="mt-4"
                ...
                <Column field="NOMBRE" header="SUBAREA" style={{ minWidth: '100px' }} sortable></Column>
