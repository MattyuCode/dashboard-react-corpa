...
const EquipoList = () => {
    ...
    const { partes } = useContext(ParteContext)

    const { deletePartes } = useContext(ParteContext)
    ...
    const handledetalle = (rowNocia, rowId) => {
        ...
        return usenavigate(`/detailsParte/${rowNocia}/${rowId}`)

    };
    const handleditar = (rowId) => {

        return usenavigate(`/editParte/${rowId}`)
    ...
    return (<div>
            ...
            <div className="d-flex mb-3 justify-content-between">
                ...
                <div className="flex flex-wrap gap-2 justify-content-between align-items-center">
                    ...
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Buscar Partes" />
                    </span>
                </div>
        ...
        <div className="card">
            ...
            <ToggleButton checked={true} onChange={(e) => setBalanceFrozen(e.value)} onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Lista de Partes" offLabel="Lista de Partes" />
            <DataTable value={partes} paginator rows={10} scrollable /*scrollHeight="400" */ className="mt-4"
